              ...
              <td align="center" valign="top">
                <table style="margin: 0 auto; border-bottom: 1px solid #dddddd;" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td style="font-size: 30px; text-align:center;">
                      <img src="http://platform.envienta.org/img/logo_stand_colored_trans.png" alt="Logo" title="Logo" style="display:block; margin: 1em auto;" width="300" />
                    </td>
                  </tr>
                </table>
                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="100%">
                  <tr style="height: 4em;">
                    <td>
                      <font style="font-size: 18px;">
                        You are receiving this email, because your order is being processed
                      </font>
                    </td>
                  </tr>
                  <tr style="height: 5em;">
                  ...
                  <tr>
                    ...
                    Billing address: {{$user->customerBillingAddress}}<br/>
                  ...
                  <tr>
                    <td>
                      ...
                      <br>
                      If you did not ordered anything in Envienta, ignore this email.<br>
                      <br>
                      </font>
                    </td>
                  </tr>
