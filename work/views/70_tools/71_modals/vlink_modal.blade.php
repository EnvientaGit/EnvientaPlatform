    ...
    <div class="modal-content">
      ...
      <div class="card-body p-3" style="margin: -1em;">
        ...
        <div id="vlinks_slider" class="carousel slide" data-ride="carousel">
          ...
          <a class="carousel-control-prev" href="#vlinks_slider" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
          </a>
          <a class="carousel-control-next" href="#vlinks_slider" role="button" data-slide="next">
