      ...
      <div class="row">
        <div class="col-md-8 bg-warning">
          ...
          {{-- <div class="row px-3 stp">
            <div class="col-md-12 bg-info" style="text-align: center;">
              <span class="text-info"><b class="text-white">SHARE THIS PROJECT</b></span>
            </div>
          </div> --}}
        </div>
        <div class="col-md-4 bg-warning">
          <div class="pull-right e_pencil"> <i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i>
        </div>
          <h1 class="display-4 py-3"><b>FarmBot</b></h1>
          <h3 class="py-3"><b>$7,500</b></h3>
          <p class="" align="justify">
            Etiam cum assumenda torquent elementum a pulvinar elementum ea veniam tempus platea montes maxime quasi sit aenean cupiditate cursus, nihil, dolores? Risus ex tristique repudiandae quasi esse nascetur dis aenean? Repellendus faucibus aenean repudiandae donec eleifend, nostrud fugit repudiandae rerum. Magnam tristique! Corporis sociis officiis est repellat ipsum, eligendi nisi.
          </p>
