<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills text-center">
      ...
      <li class="nav-item col-md-3">
        <a data-toggle="pill" href="#menu3" class="btn btn-sm btn-light bg-light nav-link active box-shadow-bottom">News Feed</a>
      </li>
      <li class="nav-item col-md-3">
...
<div class="tab-content mt-3">
  ...
  <div id="menu3" class="tab-pane animated fadeIn active">
