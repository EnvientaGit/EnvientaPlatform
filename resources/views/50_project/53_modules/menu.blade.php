    ...
    <div class="border card w-100">
      ...
      <div class="card-body p-2 text-left">
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          ...
          <a class="nav-link" id="v-pills-mentoring-tab" data-toggle="pill" href="#project_tasks" role="tab" aria-controls="project_files" aria-selected="false">@lang('project.TASKS')</a>
          <a class="nav-link" id="v-pills-investment-tab" data-toggle="pill" href="#menu3" role="tab" aria-controls="menu3" aria-selected="false">@lang('project.NEWS_FEED')</a>
