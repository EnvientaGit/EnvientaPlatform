    ...
    <div class="container align-center">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1"><span style="font-weight: normal;"><br/>@lang('front.STARTUP')</span></h1>

                <p class="mbr-text pb-3 mbr-fonts-style display-5">@lang('front.INFO')</p>
                <div class="mbr-section-btn"><a class="btn btn-md btn-primary display-4" href="#" data-toggle="modal" data-target="#newProjectModal">@lang('front.CREATE_PROJECT')</a></div>
            </div>
        </div>
    </div>
        ...
        <div class="container mb-5">
            <div class="media-container-row">
                <div class="col-12 align-center">
                    <h2 class="mbr-section-title pb-3 mbr-fonts-style display-2">@lang('front.CHOOSE_PROFILE')</h2>
                    <h3 class="mbr-section-subtitle mbr-light mbr-fonts-style display-5">@lang('front.INFO2')</h3>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-3">
                ...
                <div class="card-box">
                    <h4 class="card-title py-3 mbr-fonts-style display-5"><strong>@lang('front.HAVE_AN_IDEA')</strong></h4>
                    <p class="mbr-text mbr-fonts-style display-7">@lang('front.IDEA_INFO')<br></p>
                </div>
            </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-3">
                ...
                <div class="card-box">
                    <h4 class="card-title py-3 mbr-fonts-style display-5"><strong>@lang('front.START_CAMPAIGN')</strong></h4>
                    <p class="mbr-text mbr-fonts-style display-7">
                        @lang('front.CAMPAIGN_INFO')</p>
                </div>
            </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-3">
                ...
                <div class="card-box">
                    <h4 class="card-title py-3 mbr-fonts-style display-5"><strong>@lang('front.DOWNLOAD')</strong></h4>
                    <p class="mbr-text mbr-fonts-style display-7">
                        @lang('front.DOWNLOAD_INFO')
                    </p>
                </div>
            </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-3">
                ...
                <div class="card-box">
                    <h4 class="card-title py-3 mbr-fonts-style display-5"><strong>@lang('front.DELIVERED')</strong></h4>
                    <p class="mbr-text mbr-fonts-style display-7">
                       @lang('front.DELIVERED_INFO')
                    </p>
                </div>
            </div>
        ...
        <div class="media-container-row">
            ...
            <div class="media-content">
                <h1 class="mbr-section-title pb-3 align-left mbr-white mbr-fonts-style display-2">
                	@lang('front.ALT_TECHNOLOGICAL')
					 </h1>

                <div class="mbr-section-text  pb-3 ">
                    <p class="mbr-text align-left mbr-white mbr-fonts-style display-5">
                        @lang('front.ALT_TECHNOLOGICAL_INFO')
                    </p>
                </div>

                <div class="mbr-section-btn">
                  <a class="btn btn-md btn-primary display-4" href="#" data-toggle="modal" data-target="#newProjectModal">
	                  @lang('front.CREATE_PROJECT')
                  </a>
                </div>
            </div>
        </div>
