      ...
      <div class="col-md-12 px-0">
          <nav class="navbar navbar-expand-lg env_bg box-shadow-bottom px-4">
            <a href="{{ url('/') }}" class="mb-3">
              <img class="d-block" src="{{ URL::to('img/logo_lightbubble_white.svg') }}" height="40">
            </a>
            <p class="env_left">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <form id='search_form' class="form-inline ml-2">
                ...
                <button id="search_button" class="btn btn-sm btn-outline-light my-2 my-sm-0">Search</button>
              </form>
                
                @if(!Auth::check())
                <button id="login_btn" class="btn btn-light ml-2" data-toggle="modal" data-target="#login_dialog"> Log In </button>
                @else
                <div id="profile_block">
                  <div class="btn-group text-left">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item env_color" href="{{ "https://www.gravatar.com/" . md5( strtolower( trim( Auth::user()->email ) ) )}}" target="_blank">Profile</a>
